...
const FractionalizationPage = lazy(() => import('./pages/FractionalizationPage'))
...
const LocalizationTest = lazy(() => import('./components/LocalizationTest'))
      ...
      <Layout>
        <Suspense fallback={<LoadingSpinner />}>
          <Routes>
            ...
            <Route path="/fractionalize/:tokenId" element={<FractionalizationPage />} />
            <Route path="/staking" element={<StakingPage />} />
            <Route path="/governance" element={<GovernancePage />} />
            <Route path="/analytics" element={<AnalyticsPage />} />
            <Route path="/analytics/realtime" element={<AnalyticsDashboardPage />} />
            ...
            <Route path="/localization-test" element={<LocalizationTest />} />
          </Routes>
        </Suspense>
      </Layout>
    </Router>
