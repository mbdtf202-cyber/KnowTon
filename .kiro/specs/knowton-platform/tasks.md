...
- [x] 2.11 为 MarketplaceAMM 合约编写单元测试
...
- [x] 2.12 为 LendingAdapter 合约编写单元测试
  - 测试 Aave Pool 集成
  - 测试抵押品供应（supply）
  - 测试借贷功能（borrow, repay）
  - 测试健康因子计算
